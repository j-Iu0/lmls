...
Run standalone::
    ...
    python -m livesub.transcribe run mlx_whisper --in assets/lecture.wav
    python -m livesub.transcribe run mock --in assets/lecture.wav
    ... | python -m livesub.transcribe run mlx_whisper --raw
"""
