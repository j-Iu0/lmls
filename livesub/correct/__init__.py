"""Correction module -- repairs ASR errors in a line of English. OPTIONAL in the graph.
    ...
    fused_llm    one call that also translates (see livesub.fused)
...
Run standalone::
    ...
    python -m livesub.correct run rules --text "grade ee ent dissent"
    python -m livesub.transcribe run mock --in x.wav | python -m livesub.correct run rules
"""
