...
Every :class:`~lmls.core.interfaces.Module` that does heavy work in
:meth:`~lmls.core.interfaces.Module.start` (model download, weight load,
...
Thread-safety note
------------------
:meth:`~lmls.core.interfaces.Module._report_startup` may be called from a
