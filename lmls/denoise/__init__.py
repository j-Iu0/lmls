...
Run standalone::
    ...
    python -m lmls.denoise spectral --in noisy.wav --out clean.wav --report-snr
    python -m lmls.denoise mix-noise --speech a.wav --noise b.wav --snr 5 --out c.wav
    python -m lmls.denoise compare --speech a.wav --noise b.wav --snr 5
"""
